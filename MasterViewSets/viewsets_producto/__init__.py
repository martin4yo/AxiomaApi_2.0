...
from .atributoproducto import AtributoProductoViewSet
from .atributotipo import AtributoTipoViewSet
from .atributovalor import AtributoValorViewSet
...
from .tipoproducto import TipoProductoViewSet
